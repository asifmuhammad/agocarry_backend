                    ...
                    <div class="col-lg-6 d-flex align-items-center">
                        <div class="get_content">
                            <h3 class="f_500 f_size_30  f_p wow fadeInLeft" style="letter-spacing: 2px;"
                                data-wow-delay="0.2s"><?php echo e(config('app.name')); ?></h3>
                            ...
                            <a href="<?php echo e(config('app.landing_google_link', '#')); ?>"
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="f_widget company_widget wow fadeInLeft" data-wow-delay="0.2s">
                                <div class="widget-wrap mt-0">
                                    <?php if(config('app.landing_email')): ?>
                                        <p class="f_500 f_p f_size_15 mb-0 l_height34">
                                            <span>Email: &nbsp;</span><a href="#"
                                                class="f_500"><?php echo e(config('app.landing_email')); ?></a>
                                        </p>
                                    <?php endif; ?>

                                    <?php if(config('app.landing_phone')): ?>
                                        <p class="f_500 f_p f_size_15 mb-0 l_height34">
                                            <span>Phone:</span><a href="#"
                                                class="f_500"><?php echo e(config('app.landing_phone')); ?></a>
                                        </p>
                                    <?php endif; ?>
                                </div>
                            </div>
...
<?php echo $__env->make('vendor.landingpage.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Rana Asif\Downloads\doctorworld\doctorworld\resources\views/index.blade.php ENDPATH**/ ?>