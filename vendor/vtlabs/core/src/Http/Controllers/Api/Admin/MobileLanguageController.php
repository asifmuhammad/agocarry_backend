...
class MobileLanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $mobileLanguage = MobileLanguage::create($request->only(['language_code', 'language_title', 'content']));
    ...
    public function update(MobileLanguage $mobilelanguage, Request $request)
    {
        ...
        $mobilelanguage->fill($request->only(['language_code', 'language_title', 'content']));
