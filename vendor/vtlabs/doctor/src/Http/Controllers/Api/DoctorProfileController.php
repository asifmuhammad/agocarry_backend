...
class DoctorProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'hospitals.*.id' => 'required|exists:doctor_hospitals,id',
            'hospitals.*.fee' => 'required|numeric',
        ...
        $doctorProfile->fill($request->only(['experience_years', 'address', 'longitude', 'latitude']));
    ...
    {
        return DoctorRatingResource::collection($doctor->raters(User::class)->paginate());
    }
